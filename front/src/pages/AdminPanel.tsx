...
function Admin(props: Partial<DropzoneProps>) {
    ...
    return (
        ...
        >
            <Box mr='lg'>
                <Navbar  sx={{ backgroundColor: '#000' }} height={800} p="xs" width={{ base: 300 }}>
            ...
            <Box>
                ...
                >
                    <TextInput sx={{ width: 500 }} icon={<IconPhoto />} label="" placeholder="Url de votre image" {...form.getInputProps('url')} />
